...
const terminology = [
	{
		...
		image:
			'https://miro.medium.com/v2/resize:fit:720/format:webp/1*A7G739cVw4C9lSzwApxuvw.png',
		description:
	...
	},
	{
		...
		term: 'Transformer',
		image:
			'https://blog.roboflow.com/content/images/2023/02/Blog-Image-Template---James--1-.jpg',
		description:
		...
		source:
			'https://medium.com/@thomascountz/transformers-explained-visually-part-1-overview-of-functionality-95a6dd460452',
	},
	{
		id: 3,
	...
	},
	{
		...
		term: 'Tokenization',
		image:
			'https://media.geeksforgeeks.org/wp-content/uploads/20240124125624/Tokenization-in-NLP.png',
		description:
	...
	},
	{
		...
		term: 'Context Window',
		image:
			'https://incubity.ambilio.com/wp-content/uploads/2024/11/What-is-Context-Window-in-LLMs.png',
		description:
		...
		source:
			'https://medium.com/@crskilpatrick807/context-windows-the-short-term-memory-of-large-language-models-ab878fc6f9b5',
	},
	{
		id: 6,
		term: 'Prompt Engineering',
		image:
			'https://miro.medium.com/v2/resize:fit:750/1*jOtc1Qf_U6bY8xo_VdHa3Q.jpeg',
		description:
		...
		source:
			'https://medium.com/@promptengineering/prompt-engineering-101-1c1f5a7e3b2',
	},
	{
		id: 7,
		term: 'Fine-tuning',
		image:
			'https://miro.medium.com/v2/resize:fit:720/format:webp/1*M7BlWvqu5UPCNLw8yhV9IQ.png',
		description:
		...
		source:
			'https://rahulrajpvr7d.medium.com/what-is-fine-tuning-language-models-a-simple-explanation-8054685a4218',
	},
	{
		id: 8,
		term: 'Mixture of Experts (MoE)',
		image:
			'https://media.licdn.com/dms/image/v2/D4D12AQGAElCH8gD08g/article-cover_image-shrink_600_2000/article-cover_image-shrink_600_2000/0/1709821617807?e=2147483647&v=beta&t=n9R9d_Z8367uJJvfdiHiYvX4rQ_Hd6bZrkzve4YO3qk',
		description:
	...
	},
	{
		...
		term: 'Vectorization',
		image:
			'https://cdn.prod.website-files.com/64b3ee21cac9398c75e5d3ac/66e9918c2dfe77807c0a492c_65d4734f284089e516b145fe_arya_vector_databases_important_llms_3.png',
		description:
	...
	},
	{
		...
		term: 'Multimodality',
		image:
			'https://d3r5yd0374231.cloudfront.net/images-tek/uploads/2024/09/Multimodal-AI-%E2%80%93-How-it-Works.jpg',
		description:
		...
		source:
			'https://www.tekrevol.com/blogs/multimodal-ai-how-it-works-use-cases-examples/',
	},
	{
		id: 11,
		term: 'Reinforcement Learning from Human Feedback (RLHF)',
		image:
			'https://media.geeksforgeeks.org/wp-content/uploads/20240215172754/Reinforcement-learning-from-human-feedback.webp',
		description:
	...
	},
	{
		...
		image:
			'https://www.dremio.com/wp-content/uploads/2023/07/Wiki-Zero-Shot-Learning-Featured-Image.png',
		description:
...
const Terminology: React.FC = () => {
  // Structured data for terminology page
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "DefinedTermSet",
    "name": "AI Terminology Dictionary",
    ...
    "hasDefinedTerm": terminology.map(term => ({
      ...
      "url": `${window.location.href}#${term.term.toLowerCase().replace(/\s+/g, '-')}`,
      "image": term.image
    }))
  };
  ...
  return (
    <div className="min-h-screen w-full bg-black text-gray-100 font-rethink flex flex-col items-center py-12">
      <SEO 
        title="AI Terminology Dictionary - Learn AI & ML Concepts | AI Inventory"
        description="Comprehensive glossary of artificial intelligence and machine learning terms. Learn about LLMs, transformers, attention mechanisms, and more AI concepts."
        keywords="AI terminology, machine learning glossary, LLM definitions, transformer architecture, attention mechanism, AI dictionary, deep learning terms"
        url={window.location.href}
        type="article"
